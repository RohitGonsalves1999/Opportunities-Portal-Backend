...
class SessionCryptTest {
	...
	String invalidToken = "CFDEF3D683CB4322F3C018F5D03E73B8D9EB5346AFD2AB28B316D19CD58DE7BD6BCCA62C757EFCDB3FBD7FA3013CBDD0AE6B32B6C3BBD592AA1BF81A84F07C2BFDEDA655";
	...
	void testEncryptFail() {
		Assert.assertEquals(null, sessionCrypt.encrypt(null));
	}
	...
	@Test
	void testDecryptFail2() {
		Assert.assertEquals(null, sessionCrypt.decrypt(invalidToken));
	}
